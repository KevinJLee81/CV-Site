...
const Projects = () => {
  return (
    <>
      ...
      <div
        id="projects"
        className="text-4xl bg-base-100 font-bold flex justify-center py-28"
      >
        <h1>Projects</h1>
      </div>
      ...
      <div className="card bg-base-100 mb-32">
        <div className="card-body items-center justify-center">
          ...
          <br />- Image-Resizer reformats the image in the S3 bucket and saves a
          copy to a separate s3 bucket.
          <div className="card-actions justify-end">
            <button className="btn btn-primary">
